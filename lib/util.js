...
var DEFAULT_CDN = 'https://github.com/betabrandao/phantomjs/releases/tag/2.1.14'
...
function getDownloadSpec() {
  var cdnUrl = process.env.npm_config_phantomjs_cdnurl ||
      ...
      DEFAULT_CDN
  var downloadUrl = cdnUrl + '/' + helper.version + '-'
  var checksum = ''

  var platform = getTargetPlatform()
  var arch = getTargetArch()
  if (platform === 'linux' && arch === 'x64') {
    downloadUrl = 'https://github.com/betabrandao/phantomjs/archive/refs/tags/2.1.14.tar.gz'
    ...
    downloadUrl = 'https://github.com/betabrandao/phantomjs/archive/refs/tags/2.1.14.zip'
